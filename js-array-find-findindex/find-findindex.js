...
function findUserByUsername(usersArray, username) {return usersArray.find(function(el){return el.username === username})}
...
function removeUser(usersArray, username) {
  return usersArray.find(function (el){
    return el.username === username ? usersArray.pop(el) : undefined;
  })
}